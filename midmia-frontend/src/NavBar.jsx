    ...
    <div>
      <Navbar bg="primary" variant="dark">
        <Container>
          ...
          <Link to="/Champion" className="nav-link" style={{ marginRight: 25, marginLeft: 25 }}>챔피언</Link>
            ...
            <Link to="/Community" className="nav-link" style={{ marginRight: 25, marginLeft: 25 }}>커뮤니티</Link>
          </Nav>
          <Nav className="ml-auto">
            <Link to="/Login" className="nav-link" style={{ marginRight: 25, marginLeft: 25 }}>로그인</Link>
