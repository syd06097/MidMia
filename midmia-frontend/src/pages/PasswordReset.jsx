                ...
                <div className={styles.Flogin}>
                    <Form onSubmit={handleSubmit} style={{ width: '300px' }}>
                        <div style={{ textAlign: 'center', marginTop: '50px', marginBottom:'10px' }}>
                            <b style={{ color: 'rgb(051,102,255)', fontSize: '20px', textAlign: 'center' }}>비밀번호 초기화</b>
                        </div>
                        <Form.Group controlId="formPassword">
                            <Form.Label className={styles.Flabel}>새로운 비밀번호</Form.Label>
                            <Form.Control
                                type="password"
                                value={email}
                        ...
                        <Form.Group controlId="formPassword">
                            <Form.Label className={styles.Flabel}>새로운 비밀번호 확인</Form.Label>
                            <Form.Control
                                type="password"
                                value={email}
                                onChange={handlePasswordChange}
